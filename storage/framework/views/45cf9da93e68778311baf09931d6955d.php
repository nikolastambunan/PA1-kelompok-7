    ...
    <div class="login-wrapper">
            ...
            <div class="left-content">
                <div class="logo-area">
                    <div class="logo-badge">
                        <img src="<?php echo e(asset('image/logo/del.jpg')); ?>" alt="Del">
                    </div>
        ...
        <div class="right-panel">
            ...
            <div class="forgot-bottom">
                <a href="<?php echo e(route('password.request')); ?>" class="forgot-bottom-link">
            ...
            <div class="login-footer-text">
                &copy; <?php echo e(date('Y')); ?> GeoToba. All Rights Reserved.
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Proyek akhir 1 Real\resources\views/auth/login.blade.php ENDPATH**/ ?>