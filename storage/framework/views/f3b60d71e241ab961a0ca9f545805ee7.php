        ...
        <div class="dest-grid">
            ...
            <a href="<?php echo e(route('destinasi.detail', [$category, $item->id])); ?>" class="dest-card">
                <div class="card-img-wrapper">
                    <img src="<?php echo e($item->image_url); ?>" alt="<?php echo e($item->title_trans); ?>" loading="lazy"
                         onerror="this.onerror=null; this.src='<?php echo e(asset('image/default.jpg')); ?>'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyek akhir 1 Real\resources\views/pages/wisata/alam.blade.php ENDPATH**/ ?>