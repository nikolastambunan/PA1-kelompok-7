...
<style>
    ...
    <?php if(isset($homeSliders) && count($homeSliders) > 0): ?>
        <?php
            $total = count($homeSliders);
            $duration = $total * 4; // 4s per slide
        ?>
        <?php $__currentLoopData = $homeSliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        .hero-slide-<?php echo e($index + 1); ?> { 
            background-image: url('<?php echo e(asset($slider->image_path)); ?>'); 
            animation: slideFade <?php echo e($duration); ?>s ease-in-out infinite;
            animation-delay: <?php echo e($index * 4); ?>s; 
        }
...
<section class="hero-section">
    <div class="hero-slideshow">
        <?php if(isset($homeSliders) && count($homeSliders) > 0): ?>
            <?php $__currentLoopData = $homeSliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hero-slide hero-slide-<?php echo e($index + 1); ?>"></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php else: ?>
    ...
    <div class="hero-content">
        <div class="hero-badge"><?php echo e(__('app.home.hero_badge')); ?></div>
        <h1 class="hero-title"><?php echo __('app.home.hero_locations'); ?></h1>
        <div class="hero-divider"></div>
        <a href="#destinasi" class="hero-btn"><?php echo e(__('app.home.explore_btn')); ?> →</a>
    </div>
</section>
...
<section id="destinasi" class="section section-white">
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            <span class="badge"><?php echo e(__('app.home.featured_dest')); ?></span>
            <h2><?php echo e(__('app.home.featured_dest')); ?></h2>
            <div class="divider"></div>
            <p><?php echo e(__('app.home.featured_desc')); ?></p>
        </div>

        <?php if(!empty($featuredDestinations) && $featuredDestinations->count()): ?>
        <div class="destinasi-list">
            <?php $__currentLoopData = $featuredDestinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <div class="destinasi-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="destinasi-image" onclick="openLightbox('<?php echo e($imgSrc); ?>', '<?php echo e(addslashes($item->title)); ?>', '<?php echo e(addslashes($item->location ?? 'Lokasi belum diisi')); ?>')">
                    <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($item->title); ?>" loading="lazy" onerror="this.onerror=null; this.src='<?php echo e(asset('image/default.jpg')); ?>'">
                </div>
                <div class="destinasi-content">
                    <div class="destinasi-number"><?php echo e(sprintf('%02d', $loop->iteration)); ?></div>
                    <h3><?php echo e($item->title); ?></h3>
                    <div class="location"><i class="fas fa-map-marker-alt"></i> <?php echo e($item->location ?? 'Lokasi belum diisi'); ?></div>
                    <p><?php echo e(Str::limit(strip_tags($item->short_description ?: $item->description), 120)); ?></p>
                    <a href="<?php echo e(route('destinasi.detail', ['category' => $item->category, 'id' => $item->id])); ?>" class="destinasi-link"><?php echo e(__('app.common.read_more')); ?> →</a>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div style="text-align:center; padding:50px; color:#94a3b8;">
            ...
            <?php echo e(__('app.home.no_featured_dest')); ?>
    ...
    <div class="container">
        <div class="stats-grid">
            <div class="stat-item" data-aos="zoom-in">
                ...
                <div class="stat-label"><?php echo e(__('app.home.geosite_count')); ?></div>
            </div>
            <div class="stat-item" data-aos="zoom-in" data-aos-delay="100">
                <div class="stat-number">74.000</div>
                <div class="stat-label"><?php echo e(__('app.home.history_years')); ?></div>
            </div>
            <div class="stat-item" data-aos="zoom-in" data-aos-delay="200">
                <div class="stat-number">15</div>
                <div class="stat-label"><?php echo e(__('app.home.cultural_heritage')); ?></div>
            </div>
            <div class="stat-item" data-aos="zoom-in" data-aos-delay="300">
                <div class="stat-number">20+</div>
                <div class="stat-label"><?php echo e(__('app.nav.souvenir_umkm')); ?></div>
            </div>
        </div>
    </div>
</section>
...
<section class="section section-light">
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            <span class="badge"><?php echo e(__('app.nav.gallery')); ?></span>
            <h2><?php echo e(__('app.nav.gallery')); ?></h2>
            <div class="divider"></div>
            <p><?php echo e(__('app.home.gallery_desc')); ?></p>
        </div>
        ...
        <div class="galeri-scroll-wrapper">
            <div class="galeri-scroll" id="galeriScroll">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $galeriUnggulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $imgSrc = asset('image/default.jpg');
                ...
                ?>
                <div class="galeri-card" onclick="openLightbox('<?php echo e($imgSrc); ?>', '<?php echo e(addslashes($item->judul_trans)); ?>', '<?php echo e(addslashes($item->kategori ?? 'Galeri')); ?> · <?php echo e($item->lokasi ?? 'Danau Toba'); ?>')">
                    <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($item->judul_trans); ?>" loading="lazy" onerror="this.onerror=null; this.src='<?php echo e(asset('image/default.jpg')); ?>'">
                    <div class="caption">
                        <h4><?php echo e(Str::limit($item->judul_trans, 30)); ?></h4>
                        <p><?php echo e($item->kategori ?? 'Galeri'); ?> · <?php echo e($item->lokasi ?? 'Danau Toba'); ?></p>
                    </div>
                </div>
                ...
                <div style="padding:50px; text-align:center; color:#94a3b8; width:100%;">
                    ...
                    <p><?php echo __('app.home.no_featured_gallery'); ?></p>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div style="text-align:center; margin-top:25px;">
            <a href="<?php echo e(url('/galeri')); ?>" class="hero-btn" style="display:inline-block; padding:10px 30px; font-size:0.7rem; background:transparent; border:2px solid var(--gold); color:var(--gold-dark);">
                <?php echo e(__('app.common.see_all')); ?> <?php echo e(__('app.nav.gallery')); ?> →
            </a>
        </div>
    </div>
</section>
...
<section class="section section-light">
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            <span class="badge"><?php echo e(__('app.nav.news')); ?></span>
            <h2><?php echo e(__('app.home.news_title')); ?></h2>
            <div class="divider"></div>
            <p><?php echo e(__('app.home.news_subtitle')); ?></p>
        </div>
        ...
        <div class="berita-grid">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $beritaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
                $imgSrc = asset('image/default.jpg');
                if (!empty($item->gambar)) {
                    if (str_starts_with($item->gambar, 'http')) {
            ...
            ?>
            <div class="berita-card" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>" onclick="window.location.href='<?php echo e(url('/berita/' . $item->slug)); ?>'">
                <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($item->judul_trans); ?>" loading="lazy" onerror="this.onerror=null; this.src='<?php echo e(asset('image/default.jpg')); ?>'">
                <div class="content">
                    <div class="date">
                        <i class="far fa-calendar-alt"></i>
                        <?php echo e(\Carbon\Carbon::parse($item->created_at)->translatedFormat('d M Y')); ?>

                    </div>
                    <h3><?php echo e(Str::limit($item->judul_trans, 45)); ?></h3>
                    <p><?php echo e(Str::limit(strip_tags($item->konten_trans), 80)); ?></p>
                    <a href="<?php echo e(url('/berita/' . $item->slug)); ?>" class="btn-read"><?php echo e(__('app.common.read_more')); ?> →</a>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div style="text-align:center; padding:50px; color:#94a3b8; grid-column:span 3;">
                ...
                <p><?php echo e(__('app.news.no_data')); ?></p>
            </div>
            <?php endif; ?>
        </div>
        
        <div style="text-align:center; margin-top:30px;">
            <a href="<?php echo e(url('/berita')); ?>" class="hero-btn" style="display:inline-block; padding:10px 30px; font-size:0.7rem; background:transparent; border:2px solid var(--gold); color:var(--gold-dark);">
                <?php echo e(__('app.common.see_all')); ?> <?php echo e(__('app.nav.news')); ?> →
            </a>
        </div>
    </div>
</section>
...
<section class="cta-section">
    <div class="container">
        <div class="cta-content" data-aos="fade-up">
            <h3><?php echo e(__('app.home.start_adventure')); ?></h3>
            <div class="divider"></div>
            <p><?php echo e(__('app.home.adventure_desc')); ?></p>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyek akhir 1 Real\resources\views/pages/home.blade.php ENDPATH**/ ?>